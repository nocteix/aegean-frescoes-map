...
assets/
css/style.css
js/data.js (Generated dataset (do not hand-edit - see Data pipeline))
js/app.js (App logic)
frescoes.csv (Source-of-truth data, one row per fresco)
csv_to_data.py (frescoes.csv -> data.geojson + data.)
validate_dataset.py (anity-checks the generated data.geojson)
